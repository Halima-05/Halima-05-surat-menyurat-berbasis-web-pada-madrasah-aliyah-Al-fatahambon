            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="text" class="form-control" placeholder="Masukkan Nama Pengelola Wisata disini..." name="nama_pengelola" value="{{ old('nama_pengelola') }}">
                    </div>
                    <div class="form-group mb-2">
                        <label for="">No Hp Pengelola</label>
                        <input type="number" class="form-control" placeholder="Masukkan No Hp Pengelola Wisata disini..." name="no_hp" value="{{ old('no_hp') }}">
                    </div>
                    <div class="form-group mb-2">
