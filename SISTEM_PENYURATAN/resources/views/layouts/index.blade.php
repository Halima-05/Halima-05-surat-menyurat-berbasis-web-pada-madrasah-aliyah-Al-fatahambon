        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              {{-- data kepsek --}}
              <li class="nav-item">
                <a href="{{ route('data_kepsek.index') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Data Kepsek</p>
                </a>
              </li>
              ...
              {{-- end of data tahun ajaran --}}
              {{-- data kelas --}}
              <li class="nav-item">
                <a href="{{ route('data_kelas.index') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Data Kelas</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('undangan.index') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Undangan</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('surat_terima.index') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Pindahan Masuk</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="{{ route('panggilan.index') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Panggilan Orang Tua</p>
                </a>
              </li>
            </ul>
          </li>
...
<script>
  $(function () {
    ...
    $("#no").DataTable({
      "responsive": true, "lengthChange": true, "autoWidth": true,
      "buttons": ["csv", "excel"]
    }).buttons().container().appendTo('#no_wrapper .col-md-6:eq(0)');
    $('#example2').DataTable({
      "paging": true,
      "lengthChange": true,
      "searching": true,
