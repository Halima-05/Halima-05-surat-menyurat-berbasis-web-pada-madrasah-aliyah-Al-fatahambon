...
<html lang="en">
  ...
  <body>
    ...
    <div class="container mt-5">
        ...
        <div class="row justify-content-center"> 
            <div class="col-md-8">
                <div class="col-md-6 mb-4">
                    <table>
                        <tr>
                            <td><h6 style="border-bottom: 1px solid black;">SURAT KETERANGAN PINDAH/KELUAR</h6>
        ...
        <div class="">
            <p>Yang bertanda tangan dibawah ini Kepala Madrasah Aliyah ALfatah Ambon menerangkan bahwa :</p>
            <table>
                <tr>
                    <td>Nama</td>
        ...
        <div class="mt-2">
            <p>Telah Mengajukan permohonan pindah dari Madrasah Aliyah Al-Fatah Ambon ke Bersama ini kami sertakan surat Mutasi Keluar dan Buku Laporan Hasil pendidikan. 
                Demikian Surat Keterangan ini dibuat, untuk diketahui dan dipergunakan sebagaimana mestinya.
                </p>
        </div>
        <div class="mt-2 mb-5">
            <p class="text-right">Ambon, {{ Carbon\Carbon::parse($data->tanggal_surat)->isoFormat('D MMMM Y') }}</p>
